        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <table-component :headers="['Link','Operacíon']" ref="table"
                     :keys="['_link','operation']" :info="payind.data"
...
<script>
    ...
    export default defineComponent({
        ...
        data(){
            return{
                payind: this.payinds,
                tipo: (route().current('liquidacion.index'))?'liquidacion':'retencion',
            }
        },
        methods:{
            crearPaying(){
                this.$inertia.get(route(this.tipo+'.create'))
            },
            editarPaying(paying){
                this.$inertia.get(route('payings.edit'), {'paying': paying})
            },
