      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav me-auto">
            <template v-if="$page.props.role.includes('admin')">
              <jet-nav-link :href="route('dashboard')" :active="route().current('home')">
                Dashboard
              </jet-nav-link>
            ...
            <template v-else>
              ...
              <jet-nav-link :href="route('pqrs')" :active="route().current('pqrs')">
                  PQRS
              </jet-nav-link>
          ...
          <ul class="navbar-nav align-items-baseline">
            ...
            <jet-dropdown  v-if="$page.props.role.includes('admin')" id="settingsDropdown">
              <template #trigger>
